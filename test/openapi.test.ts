...
//       },
//     });
//     expect(result[0].http200Content!.GetPath1APIResponse).toStrictEqual({
//       userId: {
//         required: true,
//         type: 'integer',
...
//         required: true,
//         type: 'object',
//         schemaName: 'GetPath1APIResponseOfDetails',
//       },
//     });

//     expect(result[0].http200Content!.GetPath1APIResponseOfDetails).toStrictEqual({
//       age: {
//         required: false,
//         type: 'integer',
//         schemaName: undefined,
...
//     expect(result[4].http200Content!.OptionsPath1APIResponse).toStrictEqual({
//       address: {
//         required: false,
//         type: 'string',
//         schemaName: undefined,
